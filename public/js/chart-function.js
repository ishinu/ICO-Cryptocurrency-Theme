...
function chart() {
    /* Layout 1 Token Chat */
    var colors = ['#C8E883','#F7A100','#B7B698','#7d7d7d', '#d47c0c', '#f0931e', '#f6aa35', '#fbbd18'];
    var labels = ["5% Founder","10% Advisor","15% Mining","10% AirDrop","10% Gaming","20% Pre-Sale","10% ICO","20% Maxizone Exchange"];
    var data = [5,10,15,10,10,20,10,20];
    var bgColor = colors;
    var dataChart = {
        labels: labels,
        datasets: [{
    ...
    var layout2labels = ["45% Crowdsale", "10% Team", "5% Advisors and Partners", "5% Beauty, Airdrop and Referrals", "15% Reserved for Agate Ecosystem"];
